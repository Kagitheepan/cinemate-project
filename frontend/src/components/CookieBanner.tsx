...
const CookieBanner = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 p-4 sm:p-6 pb-safe pointer-events-none">
            <div className="max-w-4xl mx-auto bg-neutral-900/95 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl shadow-black/50 pointer-events-auto transform transition-all translate-y-0 relative overflow-hidden">
                {/* Glow effect */}
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                    ...
                    <div className="flex-grow">
                        <h3 className="text-xl font-bold text-white mb-2">Vos données, votre choix</h3>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto flex-shrink-0">
                        <button 
                            ...
                            className="px-5 py-2.5 rounded-lg border border-white/10 hover:bg-white/5 text-gray-300 text-sm font-medium transition-colors"
                        >
