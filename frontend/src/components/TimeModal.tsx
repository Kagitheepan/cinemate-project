...
const TimeModal = ({ onConfirm, isOpen, onClose }: TimeModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm transition-opacity duration-300">
            <div className="bg-neutral-900 border border-white/10 rounded-2xl w-full max-w-md p-6 shadow-2xl relative animate-in fade-in zoom-in duration-300">
                <button 
                    onClick={onClose}
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-2xl font-bold text-white mb-2">Combien de temps avez-vous ?</h2>
                    <p className="text-gray-400">Nous filtrerons les films pour qu'ils rentrent dans votre soirée.</p>
                </div>
                ...
                <div className="flex items-center justify-center gap-4 mb-8">
                    <div className="flex flex-col items-center">
                        ...
                        <input
                            ...
                            className="w-20 h-20 text-center text-4xl font-bold bg-neutral-800 border border-white/10 rounded-xl focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 outline-none transition-all"
                        />
                    </div>
