    ...
    if (!isAuthenticated) {
        return (
            <div className="flex-grow pt-24 pb-12 flex flex-col items-center justify-center min-h-screen text-center">
                ...
                <p className="text-gray-900 dark:text-white max-w-md">Connectez-vous et remplissez votre profil pour obtenir des suggestions 100% personnalisées.</p>
            </div>
        );
    }
        ...
        <div className="flex-grow pt-24 pb-12 transition-all duration-500 ease-in-out">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <section className="text-center py-12 relative overflow-hidden">
                    ...
                    <p className="text-lg text-gray-700 dark:text-white max-w-2xl mx-auto font-light leading-relaxed mb-8">
                ...
                <section className="mt-8">
                   {isLoading ? (
                       ...
                       <div className="text-center py-20 bg-white dark:bg-white/5 rounded-2xl border border-gray-200 dark:border-white/5 shadow-sm dark:shadow-none">
                           <p className="text-xl text-gray-900 dark:text-white font-medium">Aucun film de la sélection ne correspond à vos filtres actuels.</p>
                           <button 
