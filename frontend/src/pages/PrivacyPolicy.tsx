    ...
    return (
        <main className="min-h-screen bg-neutral-950 pt-24 pb-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-3xl font-bold text-white mb-6">Politique de confidentialite</h1>
                ...
                <div className="space-y-8 text-gray-300 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-white mb-3">Donnees collectees</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-white mb-3">Cookies et consentement</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-white mb-3">Authentification</h2>
                        <p>
